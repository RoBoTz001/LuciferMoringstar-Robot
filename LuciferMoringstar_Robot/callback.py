...
# ---------- 📁 [ | 𝗣𝗠 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            for files in filedetails:
                ...
                buttons = [[
                  InlineKeyboardButton('💠 Our Group 💠', url='https://t.me/Moviez_group_mg')
                  ]]                 
...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("🗳 channel", url="https://t.me/MM_CINEMA_CLUB"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/Moviez_group_mg")
                 ]]
            else:
                buttons = [[
                 InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
